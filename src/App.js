...
<Button variant="flat" onClick={()=>{setsearchText(searchData.current)}}>🔍</Button>
<br/>
<section className='section'>
<Button variant="flat" onClick={()=>{setsearchText("mountains")}}>Mountains</Button>{' '}
<Button variant="flat" onClick={()=>{setsearchText("beaches")}}>Beaches</Button>{' '}
<Button variant="flat" onClick={()=>{setsearchText("birds")}}>Birds</Button>{' '}
<Button variant="flat" onClick={()=>{setsearchText("food")}}>Food</Button>{' '}
</section>
